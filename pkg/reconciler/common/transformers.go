...
func UpdatePerformanceFlagsInDeploymentAndLeaderConfigMap(performanceSpec *v1alpha1.PipelinePerformanceProperties, leaderConfig, deploymentName, containerName string) mf.Transformer {
	return func(u *unstructured.Unstructured) error {
		...
		if err := StructToMap(&performanceSpec.PipelineDeploymentPerformanceArgs, &flags); err != nil {
			return err
		}
		...
		if err = StructToMap(&performanceSpec.PipelinePerformanceLeaderElectionConfig, &leaderElectionConfigMapData); err != nil {
			return err
		}
